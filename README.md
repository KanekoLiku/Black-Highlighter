...
<p align="center">
  <img width="500"
    ...
    [2019-2025 Wikidot Theme]
    Designed by Woedenaz, Croquembouche, & djkaktus
    Built by Woedenaz, Croquembouche, aismallard & rounderhouse (for some reason)
    Edited for SCP財団 by MikuKaneko, Rokurokubi, R74, ukwhatn, 7happy7, C-take

A base theme for the JP SCP Wiki utilizing more current CSS styling standards.
